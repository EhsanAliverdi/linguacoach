...
**Accurate as of: 2026-07-09 (Phase D5 — see §19a for the current phase sequence).
...
Phase D3, Plan-Sync-After-D3, Phase E8, Phase D4, Plan-Sync-After-D4, Phase E9, Phase D5) has
...
Context-Aware Today Bank Selection and Topic Matching (2026-07-09). Wired `TodayBankResourceSelector`
...
**Latest phase completed before this:** Phase E9 —
...
## 19a. Phase Sequence (as of 2026-07-09, Phase D5)
...
20d. **Next-step checkpoint after D5 (now live, not resolved in advance)** — candidates: **Phase PG-v2A** (backend skill/objective-first Practice Gym selector; see item 21), further Today composer work (a dedicated grammar-primary pattern, or richer lean-pack metadata per `TODO-D5-1`), **Phase F** (legacy freeform-generation retirement, per-pattern), or **Phase G2/G3** (backend/diagnostics cleanup). Not reached yet.
...
complete.** A next-step checkpoint now applies (PG-v2A, further Today composer work, Phase F, or
Phase G2/G3). **Phase G2/G3 (backend/diagnostics cleanup) and PG-v2 implementation have not started.**
