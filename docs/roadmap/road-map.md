...
**Accurate as of: 2026-07-09 (Phase D4 — see §19a for the current phase sequence).
...
Phase D3, Plan-Sync-After-D3, Phase E8, Phase D4) has
...
Broader Today Bank-First Composer Expansion (2026-07-09). Used the deeper E8 bank to make Today
...
**Latest phase completed before this:** Phase E8 —
...
## 19a. Phase Sequence (as of 2026-07-09, Phase D4)
...
20a. **Next-step checkpoint after D4 (now live, not resolved in advance)** — candidates: **Phase PG-v2A** (backend skill/objective-first Practice Gym selector; see item 21), further Today composer work (e.g. a dedicated grammar-primary pattern or additional pattern families), **Phase F** (legacy freeform-generation retirement, per-pattern), or **Phase G2/G3** (backend/diagnostics cleanup). Not reached yet.
...
feedback exclusions, and every legacy fallback.** **Phase D4 is complete.** A next-step checkpoint
now applies (PG-v2A, further Today composer work, Phase F, or Phase G2/G3). **Phase G2/G3
