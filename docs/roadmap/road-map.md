...
**Accurate as of: 2026-07-09 (Phase D3 — see §19a for the current phase sequence).
...
Wire Full Reading Passage Bank into Today Bank-First Composer (2026-07-09). Extended the D2 Today
...
## 19a. Phase Sequence (as of 2026-07-09, Phase D3)
...
18. **Phase E8** — further resource-platform hardening/enrichment (RAG/search, larger import support) if needed after E7 — proceed depending on what E7/D3 reveal is still missing. Available now; gated on the Phase E8/D4 decision checkpoint below. Not started.
19. **Phase E8/D4 decision checkpoint** — **now live (after Phase D3), not resolved in advance**: start Phase D4 (broader Today composer expansion beyond the current reading-passage/vocabulary slice), continue Phase E8 for resource depth/types, continue with Practice Gym v2 (PG-v2A), or do Phase G2/G3 (backend/diagnostics cleanup) next. Not reached yet.
20. **Phase D4 or Phase PG-v2A** — whichever the Phase E8/D4 decision checkpoint selects. Both **not started**.
...
complete.** A Phase E8/D4 decision checkpoint now applies (item 19 above), not resolved in advance:
Phase D4 (broader Today composer expansion), Phase E8 (resource depth/types), Phase G2/G3
(backend/diagnostics cleanup), or PG-v2. **Phase E8, Phase D4, Phase G2/G3, and PG-v2
