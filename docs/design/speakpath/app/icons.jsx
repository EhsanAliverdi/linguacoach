...
(function () {
  ...
  const Icon = {
    ...
    sidebar: (p) => React.createElement(S, p, React.createElement("rect", { x: 3, y: 4, width: 18, height: 16, rx: 3 }), L(9, 4, 9, 20)),
    panelLeft: (p) => React.createElement(S, p, P("M14 7l-4 5 4 5")),
