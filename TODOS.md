...
- TODO-10X-G: full admin page refactor using new wrappers — replace remaining inline CSS in feature pages; finish AI Config, Integrations, Curriculum form internals; full page-by-page admin UX redesign.
