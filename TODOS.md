...
- TODO-10W-DP-KEY-ENCRYPT: Encrypt the Data Protection key ring at rest (Windows DPAPI, Azure Key Vault, or similar). Currently keys are stored as plaintext XML on disk. Required for hardened production deployments where filesystem access is a threat.
