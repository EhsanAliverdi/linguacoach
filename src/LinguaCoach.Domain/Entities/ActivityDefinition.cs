...
/// (`Resource Bank Item → Learn Item/Activity → Module`, see
/// docs/architecture/product-model-realignment-h0.md). Generated from one or more selected
/// published Resource Bank rows (see <see cref="ActivityResourceLink"/>) or from an existing
/// <see cref="LearnItem"/>, or authored manually. Always starts
...
/// (Today materialization, Practice Gym) — <see cref="ActivityDefinition"/> is a reusable design,
...
/// (<c>PracticeGymGenerationJob.TemplateMigratedPatternKeys</c>) — <see cref="ActivityDefinition"/>
/// is a new, separate H4 foundation-phase entity with Resource Bank/Learn Item traceability that
...
/// </list>
/// </summary>
public sealed class ActivityDefinition : BaseEntity
{
    ...
    /// <see cref="Infrastructure.LearnItems"/> sibling namespace's Activity generation service for
    ...
    public ActivityRendererType RendererType { get; private set; }
    ...
    /// <summary>Optional link to the <see cref="LearnItem"/> this Activity practices — null when
    /// generated directly from Resource Bank rows or authored manually with no Learn Item chosen.</summary>
    public Guid? LearnItemId { get; private set; }

    public ActivitySourceMode SourceMode { get; private set; }
    ...
    public ActivityDefinition(
        ...
        string instructions,
        string activityType,
        ActivityRendererType rendererType,
        ActivitySourceMode sourceMode,
    ...
    /// <see cref="LearnItem.UpdateDraft"/>: reject first to reopen editing. Editing a rejected
