...
public static class ExerciseTypeDefinitionSeeder
{
    ...
    [
        ...
        Planned("read_aloud", "Read Aloud", "Read text aloud clearly.", "speaking", "[\"reading\"]", "PTE Speaking", true, false),
        Planned("repeat_sentence", "Repeat Sentence", "Repeat an audio sentence accurately.", "speaking", "[\"listening\"]", "PTE Speaking", true, false, requiresAudio: true),
        Planned("describe_image", "Describe Image", "Describe an image aloud.", "speaking", "[]", "PTE Speaking", true, false, requiresImage: true),
        Planned("respond_to_situation", "Respond to Situation", "Speak a response to a workplace situation.", "speaking", "[]", "PTE Speaking", true, false),
        Planned("retell_lecture", "Retell Lecture", "Retell an audio lecture in your own words.", "speaking", "[\"listening\"]", "PTE Speaking", true, false, requiresAudio: true),
        Planned("summarize_group_discussion", "Summarize Group Discussion", "Summarize a spoken discussion.", "speaking", "[\"listening\"]", "PTE Speaking", true, false, requiresAudio: true),
        Planned("answer_short_question", "Answer Short Question", "Answer a short spoken question.", "speaking", "[\"listening\"]", "PTE Speaking", true, false, requiresAudio: true),
        Planned("summarize_written_text", "Summarize Written Text", "Write a concise summary of a passage.", "writing", "[\"reading\"]", "PTE Writing", true, false),
        Planned("write_essay", "Write Essay", "Write a structured essay.", "writing", "[]", "PTE Writing", true, false),
        Planned("reading_writing_fill_in_blanks", "Reading and Writing Fill in Blanks", "Choose words for text blanks.", "reading", "[\"writing\"]", "PTE Reading", true, false),
        Planned("reading_multiple_choice_multi", "Reading Multiple Choice Multiple", "Choose multiple answers from reading.", "reading", "[]", "PTE Reading", true, false),
        Planned("reorder_paragraphs", "Reorder Paragraphs", "Put paragraphs in logical order.", "reading", "[]", "PTE Reading", true, false),
        Planned("reading_fill_in_blanks", "Reading Fill in Blanks", "Fill blanks in a reading passage.", "reading", "[]", "PTE Reading", true, false),
        Planned("reading_multiple_choice_single", "Reading Multiple Choice Single", "Choose one answer from reading.", "reading", "[]", "PTE Reading", true, false),
        Planned("summarize_spoken_text", "Summarize Spoken Text", "Write a summary of spoken audio.", "listening", "[\"writing\"]", "PTE Listening", true, false, requiresAudio: true),
        Planned("listening_multiple_choice_multi", "Listening Multiple Choice Multiple", "Choose multiple answers from audio.", "listening", "[]", "PTE Listening", true, false, requiresAudio: true),
        Planned("listening_fill_in_blanks", "Listening Fill in Blanks", "Fill missing words from audio.", "listening", "[\"writing\"]", "PTE Listening", true, false, requiresAudio: true),
        Planned("highlight_correct_summary", "Highlight Correct Summary", "Choose the correct audio summary.", "listening", "[\"reading\"]", "PTE Listening", true, false, requiresAudio: true),
        Planned("listening_multiple_choice_single", "Listening Multiple Choice Single", "Choose one answer from audio.", "listening", "[]", "PTE Listening", true, false, requiresAudio: true),
        Planned("select_missing_word", "Select Missing Word", "Select the missing audio ending.", "listening", "[]", "PTE Listening", true, false, requiresAudio: true),
        Planned("highlight_incorrect_words", "Highlight Incorrect Words", "Find words that differ from audio.", "listening", "[\"reading\"]", "PTE Listening", true, false, requiresAudio: true),
        Planned("write_from_dictation", "Write From Dictation", "Write the sentence you hear.", "listening", "[\"writing\"]", "PTE Listening", true, false, requiresAudio: true)
    ];
