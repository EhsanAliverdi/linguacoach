...
namespace LinguaCoach.Persistence.Migrations
{
    ...
    [Migration("20260710021249_Phase_I0_DropTypedBankTables")]
    partial class Phase_I0_DropTypedBankTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LinguaCoach.Domain.Entities.ActivityFeedbackSignal", b =>
                {
                    ...
                    b.Property<Guid?>("StudentActivityReadinessItemId")
                        .HasColumnType("uuid")
                        .HasColumnName("student_activity_readiness_item_id");
                    ...
                    b.HasIndex("StudentActivityReadinessItemId");
            ...
            modelBuilder.Entity("LinguaCoach.Domain.Entities.ActivityTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("AssetRequirementsJson")
                        .HasColumnType("text")
                        .HasColumnName("asset_requirements_json");
                    ...
                    b.Property<string>("FormIoBaseSchemaJson")
                        .HasColumnType("jsonb")
                        .HasColumnName("form_io_base_schema_json");

                    b.Property<string>("GenerationInstructions")
                        .HasColumnType("text")
                        .HasColumnName("generation_instructions");
                    ...
                    b.Property<string>("ScoringModelJson")
                        .HasColumnType("jsonb")
                        .HasColumnName("scoring_model_json");
                    ...
                    b.HasIndex("Key", "VersionNumber")
                        .IsUnique()
                        .HasDatabaseName("ix_activity_templates_key_version");

                    b.HasIndex("Skill", "CefrLevel", "IsPublished")
            ...
            modelBuilder.Entity("LinguaCoach.Domain.Entities.StudentActivityReadinessItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("AdminReviewNotes")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)")
                        .HasColumnName("admin_review_notes");

                    b.Property<string>("AdminReviewReason")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("admin_review_reason");
                    ...
                    b.Property<DateTime?>("AdminReviewedAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("admin_reviewed_at_utc");

                    b.Property<Guid?>("AdminReviewedByUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("admin_reviewed_by_user_id");
                    ...
                    b.Property<string>("CurriculumObjectiveTitle")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)")
                        .HasColumnName("curriculum_objective_title");
                    ...
                    b.Property<string>("FormIoSchemaSnapshotJson")
                        .HasColumnType("jsonb")
                        .HasColumnName("form_io_schema_snapshot_json");
                    ...
                    b.Property<string>("GeneratedByProvider")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("generated_by_provider");

                    b.Property<bool>("IsLowerLevelContent")
                        .HasColumnType("boolean")
                        .HasColumnName("is_lower_level_content");
                    ...
                    b.Property<string>("OriginalCefrLevelSnapshot")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
                        .HasColumnName("original_cefr_level_snapshot");
                    ...
                    b.Property<string>("PersonalizationReason")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("personalization_reason");
                    ...
                    b.Property<bool>("RequiresAdminReview")
                        ...
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("requires_admin_review");

                    b.Property<DateTime?>("ReservedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("reserved_at");

                    b.Property<string>("RoutingExplanation")
                        .HasColumnType("text")
                        .HasColumnName("routing_explanation");
                    ...
                    b.Property<string>("ScoringRulesSnapshotJson")
                        .HasColumnType("jsonb")
                        .HasColumnName("scoring_rules_snapshot_json");
                    ...
                    b.Property<string>("TranslationHelpPreference")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                    ...
                    b.HasIndex("RequiresAdminReview", "AdminReviewStatus")
                        .HasDatabaseName("ix_readiness_items_admin_review_status");

                    b.HasIndex("StudentId", "Status", "Source")
                        .HasDatabaseName("ix_readiness_items_student_status_source");

                    b.HasIndex("StudentId", "Status", "Priority", "CreatedAt")
            ...
            modelBuilder.Entity("LinguaCoach.Domain.Entities.ActivityFeedbackSignal", b =>
                {
                    ...
                    b.HasOne("LinguaCoach.Domain.Entities.ActivityTemplate", null)
                        .WithMany()
                        .HasForeignKey("SourceTemplateId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("LinguaCoach.Domain.Entities.StudentActivityReadinessItem", null)
                        .WithMany()
                        .HasForeignKey("StudentActivityReadinessItemId")
                        .OnDelete(DeleteBehavior.Restrict);
