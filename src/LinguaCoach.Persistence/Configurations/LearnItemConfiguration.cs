...
internal sealed class LearnItemConfiguration : IEntityTypeConfiguration<LearnItem>
{
    public void Configure(EntityTypeBuilder<LearnItem> builder)
    {
        builder.ToTable("learn_items");
        ...
        builder.HasIndex(e => e.ReviewStatus).HasDatabaseName("ix_learn_items_review_status");
        builder.HasIndex(e => e.CefrLevel).HasDatabaseName("ix_learn_items_cefr_level");
        builder.HasIndex(e => e.Skill).HasDatabaseName("ix_learn_items_skill");
        builder.HasIndex(e => e.Subskill).HasDatabaseName("ix_learn_items_subskill");
        builder.HasIndex(e => e.CreatedAt).HasDatabaseName("ix_learn_items_created_at");
    }
}
