...
internal sealed class WritingEvaluationAppliedSignalConfiguration
    : IEntityTypeConfiguration<WritingEvaluationAppliedSignal>
{
    public void Configure(EntityTypeBuilder<WritingEvaluationAppliedSignal> builder)
    {
        builder.ToTable("writing_evaluation_applied_signals");
        ...
        builder.HasIndex(e => e.EvaluationId)
            .IsUnique()
            .HasDatabaseName("ix_writing_applied_signals_evaluation_unique");

        builder.HasIndex(e => e.StudentProfileId)
            .HasDatabaseName("ix_writing_applied_signals_student");
    }
}
