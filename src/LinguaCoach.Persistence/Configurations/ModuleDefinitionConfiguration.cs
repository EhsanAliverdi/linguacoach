...
internal sealed class ModuleDefinitionConfiguration : IEntityTypeConfiguration<ModuleDefinition>
{
    public void Configure(EntityTypeBuilder<ModuleDefinition> builder)
    {
        ...
        builder.HasIndex(e => e.ReviewStatus).HasDatabaseName("ix_module_definitions_review_status");
        builder.HasIndex(e => e.CefrLevel).HasDatabaseName("ix_module_definitions_cefr_level");
        builder.HasIndex(e => e.Skill).HasDatabaseName("ix_module_definitions_skill");
        builder.HasIndex(e => e.Subskill).HasDatabaseName("ix_module_definitions_subskill");
        builder.HasIndex(e => e.CreatedAt).HasDatabaseName("ix_module_definitions_created_at");
    }
}
