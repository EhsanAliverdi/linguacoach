...
export interface ListeningFillInBlanksContent {
  ...
  gaps: ListeningFillInBlanksGap[];
}

export interface ListeningFillInBlanksAnswer {
...
export class ListeningFillInBlanksComponent {
  @Input() content!: ListeningFillInBlanksContent;
  @Input() disabled = false;
  @Output() submitted = new EventEmitter<ListeningFillInBlanksAnswer>();
