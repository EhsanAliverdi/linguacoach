...
describe('PatternEvaluationResultComponent — score-aware feedback', () => {
  ...
  // ── scoreBandInstruction — must not say "Improve your answer" at 100% ──────
