...
export class LessonComponent implements OnInit {
  ...
  /** Per-exercise prepare errors (exerciseId â†’ message). 503 from /prepare is shown inline. */
  prepareErrors = signal<Record<string, string>>({});

  /**
   * Local activityId overrides per exercise â€” populated when /prepare returns in this
