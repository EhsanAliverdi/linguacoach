...
export const routes: Routes = [
  ...
  // ── Admin ─────────────────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      {
        path: 'skill-graph/audit',
        loadComponent: () => import('./features/admin/admin-skill-graph/admin-skill-graph-audit/admin-skill-graph-audit.component').then(m => m.AdminSkillGraphAuditComponent),
      },
      {
