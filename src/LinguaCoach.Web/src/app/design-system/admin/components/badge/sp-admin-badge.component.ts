...
@Component({
  ...
  styles: [`
    ...
    .sp-adm-badge-sm { padding:2px 8px;  font-size:11.5px; line-height:1.4; font-weight:700; }
    .sp-adm-badge-md { padding:3px 10px; font-size:12px;   line-height:1.4; font-weight:700; }
    ...
    .sp-adm-badge-soft-primary { background:var(--sp-admin-primary-bg,#EDEBFF); color:var(--sp-admin-primary,#5B4BE8); }
    ...
    .sp-adm-badge-solid-primary { background:var(--sp-admin-primary,#5B4BE8); color:#fff; }
    ...
    .sp-adm-badge-outline-primary { background:transparent; color:var(--sp-admin-primary,#5B4BE8); box-shadow:0 0 0 1px var(--sp-admin-primary,#5B4BE8) inset; }
