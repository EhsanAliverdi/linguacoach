...
@Component({
  ...
  template: `
    <aside
      class="fixed flex flex-col top-0 left-0 h-screen transition-all duration-300 ease-in-out z-[99] overflow-hidden"
      style="background:#fff;border-right:1px solid var(--sp-admin-border);"
      [ngClass]="{
        'w-[240px]': !collapsed,
        'w-[64px]': collapsed,
