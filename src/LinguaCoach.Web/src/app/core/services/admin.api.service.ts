...
import {
  ...
  SkillGraphBatchActionResponse, SkillGraphBatchRejectResponse, SkillGraphBatchRejectResult, SkillGraphCoverageResponse,
...
export class AdminApiService {
  ...
  batchRejectSkillGraphNodes(ids: string[], reason: string, confirm = false): Observable<SkillGraphBatchRejectResult> {
    return this.http.post<SkillGraphBatchRejectResult>(`${this.api}/skill-graph/nodes/batch/reject`, { ids, reason, confirm });
  }
  ...
  addSkillGraphPrerequisite(nodeId: string, prerequisiteNodeId: string): Observable<AddSkillGraphPrerequisiteResponse> {
    return this.http.post<AddSkillGraphPrerequisiteResponse>(`${this.api}/skill-graph/nodes/${nodeId}/prerequisites`, { prerequisiteNodeId });
  }
